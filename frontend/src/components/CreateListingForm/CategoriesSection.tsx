...
export function CategoriesSection({ titleText, selectedCategoryIds, setSelectedCategoryIds }: CategoriesSectionProps) {
  ...
  return (
    <section className="mt-14 max-md:mt-10">
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-[600px] px-6 py-8 rounded-3xl border bg-zinc-800 border-neutral-700">
